...
const IconButton = ({icon,label, text}) => {
    return(
        <div className="dropdown">
            ...
            <ul tabIndex={0} className="dropdown-content menu p-5 shadow bg-zinc-800 rounded-box w-[40rem]">
                <div className={'p-6'}>
...
function AboutButtonGroup() {
    ...
    return (
        <div className="flex navbar-start justify-start relative text-white">
